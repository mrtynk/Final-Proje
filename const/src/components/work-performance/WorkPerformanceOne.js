                                ...
                                <div className="work-perfomance-one__content">
                                    <div className="sec-title">
                                        <div className="sec-title__tagline">
                                            <h6>İş Performansı</h6> <span className="right"></span>
                                        </div>
                                        <h2 className="sec-title__title">Şehirde Güçlü Binalar <br /> İnşa Ediyoruz</h2>
