                                ...
                                <div className="benefits-one__content">
                                    <div className="sec-title">
                                        <div className="sec-title__tagline">
                                            <h6>Avantajlarımız</h6> <span className="right"></span>
                                        </div>
                                        <h2 className="sec-title__title">Üstün ve Kaliteli <br /> Sonuçlar Sunuyoruz</h2>
                                    ...
                                    <ul className="benefits-one__content-list">
                                        <li>
                                            ...
                                            <div className="text">
                                                <p>En iyi hizmet için elimizden geleni yapıyoruz.</p>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div className="text">
                                                <p>Müşteri memnuniyeti her zaman önceliğimizdir.</p>
                                            </div>
                                        </li>
                                    </ul>
