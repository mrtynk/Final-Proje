                            ...
                            <div className="col-xl-6">
                                <div className="about-one__content">
                                    <div className="sec-title">
                                        ...
                                        <p className="sec-title__text">Çeşitli Lorem Ipsum pasajları bulunmaktadır, ancak çoğunluğu mizah veya rastgele sözcükler enjekte edilerek değişikliğe uğramıştır ve bu yüzden biraz bile anlamlı görünmez.</p>
                                    </div>
