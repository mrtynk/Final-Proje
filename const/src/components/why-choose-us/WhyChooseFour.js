                            ...
                            <div className="col-xl-6">
                                <div className="why-choose-two__content">
                                    <div className="sec-title">
                                        ...
                                        <h2 className="sec-title__title">Üstün ve Popüler <br />Hizmetler Sunuyoruz</h2>
                                        <p className="sec-title__text">Kimse kendi isteğiyle acı çekmekten hoşlanmaz, zorunluluktan kaçmaz, ya da acıdan zevk almaz. </p>
                                    </div>
