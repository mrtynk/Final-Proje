                                ...
                                <div className="why-choose-one__content">
                                    <div className="sec-title">
                                        <div className="sec-title__tagline">
                                            <h6>Neden Bizi Seçmelisiniz</h6> <span className="right"></span>
                                        </div>
                                        <h2 className="sec-title__title">Neden En İyiyiz</h2>
                                    ...
                                    <div className="why-choose-one__content-top">
                                        ...
                                        <div className="text-box">
                                            <p>Bir sayfanın düzenine bakarken, okuyucu genellikle okunabilir içeriğe odaklanır ve dikkati dağılır. Lorem Ipsum kullanılmasının sebebi ise yazının daha doğal görünmesini sağlamaktır.</p>
                                        </div>
                                    </div>
