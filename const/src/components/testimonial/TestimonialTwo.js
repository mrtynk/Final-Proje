                        ...
                        <div className="testimonials-two__right">
                            <div className="sec-title">
                                <div className="sec-title__tagline">
                                    <h6>Referanslar</h6> <span className="right"></span>
                                </div>
                                <h2 className="sec-title__title">Müşterilerimiz Ne Diyor</h2>
                            </div>
                            <Swiper
                                            ...
                                            <div className="testimonials-two-content__single">
                                                <div className="testimonials-two-content__single-inner">
                                                    ...
                                                    <div className="content-box">
                                                        <h4>Dağlar arasında üçüncü kurallar bizdir. İşaretler yaratıldı.
                                                            Günler, yıllar, ilk kuralımızdır, gece hayatımızı şekillendirir.</h4>

                                                        <div className="name">
                                                            <h4>Sayın Sumi Aktar</h4>
