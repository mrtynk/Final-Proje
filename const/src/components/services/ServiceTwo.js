                    ...
                    <div className="container">
                        <div className="sec-title text-center">
                            <div className="sec-title__tagline">
                                ...
                                <h6>Şirket Hizmetleri</h6> <span className="right"></span>
                            </div>
                            <h2 className="sec-title__title">Şirketimizin En İyi Hizmetleri</h2>
                        </div>
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-lg-4">
                                <div className="services-two__single">
                                    ...
                                    <div className="services-two__single-content">
                                        <h2><Link to={process.env.PUBLIC_URL + `/general-contracting`}>Ağır Makine</Link></h2>
                                        <p>Ut enim ad minim veniam, nostrud egzersizlerde çalışmaya istekli olanlara, rahatlıkla uyum sağlar.</p>
                                        <div className="btn-box">
                                            <Link to={process.env.PUBLIC_URL + `/general-contracting`}>Daha Fazla Oku <span className="icon-plus-sign"></span></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-4">
                                <div className="services-two__single">
                                    ...
                                    <div className="services-two__single-content">
                                        <h2><Link to={process.env.PUBLIC_URL + `/general-contracting`}>Şık Bina</Link></h2>
                                        <p>Ut enim ad minim veniam, nostrud egzersizlerde çalışmaya istekli olanlara, rahatlıkla uyum sağlar.</p>
                                        <div className="btn-box">
                                            <Link to={process.env.PUBLIC_URL + `/general-contracting`}>Daha Fazla Oku <span className="icon-plus-sign"></span></Link>
                                        </div>
