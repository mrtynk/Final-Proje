                    ...
                    <div className="container-fluid">
                        <div className="sec-title text-center">
                            <div className="sec-title__tagline">
                                ...
                                <h6>Projelerimiz</h6> <span className="right"></span>
                            </div>
                            <h2 className="sec-title__title">Devam Eden Projelerimiz</h2>
                        </div>
                                ...
                                <div className="project-one__menu-box">
                                    <ul className="project-filter clearfix post-filter has-dynamic-filters-counter">
                                        <li data-filter=".filter-item" className="active">
                                            <span className="filter-text"> <i className="icon-hammer"></i> Tüm Projeler</span>
                                        </li>
                                        <li data-filter=".factory"><span className="filter-text"> <i className="icon-wrench"></i> Fabrika</span></li>
                                        <li data-filter=".offices"><span className="filter-text"> <i className="icon-surgery"></i> Ofisler</span></li>
                                        <li data-filter=".interios"><span className="filter-text"> <i className="icon-line-chart"></i> İç Mekanlar</span></li>
                                        <li data-filter=".bulding"><span className="filter-text"> <i className="icon-hotel"></i> Binalar</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="project-one__single">
                                    <div className="project-one__single-img">
                                        ...
                                        <div className="content-box">
                                            <h2><Link to={process.env.PUBLIC_URL + `/portfolio-details`}>Doku Tasarımı</Link></h2>
                                            <p>Bina İç Mekanı</p>
                                        </div>
                                    </div>
                                </div>
