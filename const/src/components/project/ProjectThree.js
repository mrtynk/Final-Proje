                    ...
                    <div className="container-fluid">
                        <div className="sec-title text-center">
                            <div className="sec-title__tagline">
                                ...
                                <h6>SON PROJELER</h6> <span className="right"></span>
                            </div>
                            <h2 className="sec-title__title">
                                En son tamamlanan ve <br /> devam eden projelerimiz.
                            </h2>
                        </div>
                        <div className="row">
                                ...
                                <div className="project-three__carousel owl-carousel owl-theme">
                                    ...
                                    <div className="project-three__single">
                                        <div className="project-three__single-img">
                                            ...
                                            <div className="icon-box">
                                                <a className="img-popup" href={publicUrl+"assets/images/update1.0/project-v3-img1.jpg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                            <div className="content-box">
                                                <p>inşaat</p>
                                                <h3><Link to={process.env.PUBLIC_URL + `/portfolio-details`}>dowson inşaat</Link></h3>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="project-three__single">
                                        <div className="project-three__single-img">
                                            ...
                                            <div className="icon-box">
                                                <a className="img-popup" href={publicUrl+"assets/images/update1.0/project-v3-img2.jpg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                            <div className="content-box">
                                    ...
                                    <div className="project-three__single">
                                        <div className="project-three__single-img">
                                            ...
                                            <div className="icon-box">
                                                <a className="img-popup" href={publicUrl+"assets/images/update1.0/project-v3-img3.jpg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                            <div className="content-box">
                            ...
                            <div className="col-xl-12">
                                <div className="project-three-more-project-btn text-center">
                                    <div className="btn-box">
                                        <Link to="/portfolio" className="thm-btn" data-text="Tüm Projeleri Gör +">Tüm Projeleri Gör +</Link>
                                    </div>
                                </div>
                            </div>
