                        ...
                        <div className="project-two__top">
                            <div className="sec-title">
                                <div className="sec-title__tagline">
                                    <h6>Çalışmalarımız</h6> <span className="right"></span>
                                </div>
                                <h2 className="sec-title__title">Tamamlanan Projeler</h2>
                            </div>
                            <div className="btn-box">
                                <Link to={process.env.PUBLIC_URL + `/portfolio`} className="thm-btn" data-text="Tüm Portföyü Gör +">
                                    Tüm Portföyü Gör +
                                </Link>
                            </div>
                        </div>
