                                ...
                                <div className="row">
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="mission-vision-one__single">
                                            ...
                                            <h2>Misyonumuz</h2>
                                            <p>Yüksek kaliteli hizmet ve çözümler sunarak, müşterilerimizin beklentilerini aşmayı amaçlıyoruz.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="mission-vision-one__single">
                                            ...
                                            <h2>Vizyonumuz</h2>
                                            <p>Yenilikçi yaklaşımlar ve sürdürülebilir büyümeyle sektör lideri olmak için çalışıyoruz.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
