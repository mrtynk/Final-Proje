                    ...
                    <div className="container">
                        <div className="sec-title text-center">
                            <div className="sec-title__tagline">
                                ...
                                <h6>Özelliklerimiz</h6> <span className="right"></span>
                            </div>
                            <h2 className="sec-title__title">Neden Bizi Seçmelisiniz</h2>
                        </div>
                        <div className="row">
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="feature-two__single">
                                    ...
                                    <h3><Link to={process.env.PUBLIC_URL + `/`}>Kömür Kazıma</Link></h3>
                                    <p>Bu alanda açıklama yer alıyor. Buraya projenize uygun kısa bir tanım ekleyebilirsiniz.</p>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="feature-two__single">
                                    ...
                                    <h3><Link to={process.env.PUBLIC_URL + `/`}>Ev Planlama</Link></h3>
                                    <p>Bu alanda açıklama yer alıyor. Buraya projenize uygun kısa bir tanım ekleyebilirsiniz.</p>
                                    <div className="btn-box">
                                        <Link to={process.env.PUBLIC_URL + `/`}><span className="icon-right-arrow-1"></span></Link>
                                    </div>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="feature-two__single">
                                    ...
                                    <h3><Link to={process.env.PUBLIC_URL + `/`}>Maden Fabrikası</Link></h3>
                                    <p>Bu alanda açıklama yer alıyor. Buraya projenize uygun kısa bir tanım ekleyebilirsiniz.</p>
                                    <div className="btn-box">
                                        <Link to={process.env.PUBLIC_URL + `/`}><span className="icon-right-arrow-1"></span></Link>
                                    </div>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6">
                                <div className="feature-two__single">
                                    ...
                                    <h3><Link to={process.env.PUBLIC_URL + `/`}>İç Tasarım</Link></h3>
                                    <p>Bu alanda açıklama yer alıyor. Buraya projenize uygun kısa bir tanım ekleyebilirsiniz.</p>
                                    <div className="btn-box">
                                        <Link to={process.env.PUBLIC_URL + `/`}><span className="icon-right-arrow-1"></span></Link>
                                    </div>
