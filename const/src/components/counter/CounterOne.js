                                ...
                                <div className="counter-one__single">
                                    <div className="counter-one__single-inner">
                                        ...
                                        <div className="text-box">
                                            ...
                                            <p className="counter-one__text">Kazandığımız Ödüller</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="counter-one__single">
                                    <div className="counter-one__single-inner">
                                        ...
                                        <div className="text-box">
                                            ...
                                            <span className="counter-one__letter">K</span>
                                            <p className="counter-one__text">Tamamlanan Proje</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="counter-one__single">
                                    <div className="counter-one__single-inner">
                                        ...
                                        <div className="text-box">
                                            ...
                                            <span className="counter-one__letter">K</span>
                                            <span className="counter-one__plus">+</span>
                                            <p className="counter-one__text">Mutlu Müşteri</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="counter-one__single">
                                    <div className="counter-one__single-inner">
                                        ...
                                        <div className="text-box">
                                            ...
                                            <span className="counter-one__letter">K</span>
                                            <span className="counter-one__plus">+</span>
                                            <p className="counter-one__text">Tamamlanan İş</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
