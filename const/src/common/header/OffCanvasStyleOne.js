                                    ...
                                    <div className="content-inner">
                                        ...
                                        <div className="content-box">
                                            ...
                                            <div className="inner-text">
                                                <p>Yaygın inanışın aksine, Lorem Ipsum sadece rastgele bir metin değildir. 
                                                   Kökenleri M.Ö. 45 yılına dayanan klasik Latin edebiyatından gelmektedir, 
                                                   yani 2000 yıldan daha eskidir.
                                                </p>
                                            </div>
                                        </div>

                                        <div className="form-inner">
                                            <h4>Ücretsiz Teklif Alın</h4>
                                            <form action="index.html" method="post">
                                                ...
                                                <div className="form-group message-btn">
                                                    <button className="thm-btn" data-text="Gönder +" type="submit" data-loading-text="Lütfen bekleyin...">Gönder</button>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div className="sidebar-contact-info">
                                            ...
                                            <ul>
                                                <li>
                                                    <span className=" icon-maps-and-flags"></span> Brooklyn Caddesi 88, New York
                                                </li>
                                                <li>
