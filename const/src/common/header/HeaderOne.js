                                ...
                                <div className="main-header-three__top-inner">
                                    <div className="left">
                                        ...
                                        <ul className="menu-box">
                                            <li><Link to={process.env.PUBLIC_URL + `/`}>İnsanlar</Link></li>
                                            <li><Link to={process.env.PUBLIC_URL + `/`}>Kariyer</Link></li>
                                            <li><Link to={process.env.PUBLIC_URL + `/`}>Haberler</Link></li>
                                        </ul>
                                    </div>

                                    <div className="right">
                                        <div className="title">
                                            <p>Bizimle Sosyal Medyada!</p>
                                        </div>
